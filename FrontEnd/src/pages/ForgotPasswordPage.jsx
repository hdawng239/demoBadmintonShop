              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-zinc-50 dark:bg-[#181a24] border border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-white rounded-xl text-xs outline-none focus:border-[#ea580c]"
                  />
            ...
            <form onSubmit={handleResetPassword} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="123456"
                  className="w-full px-4 py-2.5 bg-zinc-50 dark:bg-[#181a24] border border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-white rounded-xl text-center text-base tracking-widest font-mono font-bold outline-none focus:border-[#ea580c]"
                />
              </div>
