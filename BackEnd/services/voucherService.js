...
// Chuẩn hoá dữ liệu voucher khi TẠO MỚI (đủ 10 cột, có default).
...
// Chuẩn hoá khi CẬP NHẬT (chỉ đụng tới field có trong payload).
...
// SERVICE = toàn bộ nghiệp vụ voucher (trước đây nằm trong controller).
const VoucherService = {
    // Kiểm tra & tính toán số tiền giảm khi khách áp mã.
